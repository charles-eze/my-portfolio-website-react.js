            ...
            <footer className='px-10 pt-16 pb-5 mx-auto text-white max-w-7xl'>
                ...
                <div className='flex flex-col-reverse items-center mb-20 space-y-8 space-y-reverse md:items-start md:space-y-0 md:space-x-16 md:flex-row'>
                    <div className='text-lg md:w-1/2'>
                        ...
                        style={{animationFillMode: 'both', animationDuration: '1000ms', animationDelay: '0ms', animationIterationCount: 1, opacity: 1, animationName: 'react-reveal-301476514021954-2'}}>
                    ...
                    <div className='w-full md:w-1/2'>
                        <form className='react-reveal w-full'
                            method='post'
                            id='contact-form'
                            name='contact-forms'
                            style={{animationFillMode: 'both', animationDuration: '1000ms', animationDelay: '0ms', animationIterationCount: 1, opacity: 1, animationName: 'react-reveal-301476514021954-3'}}>
